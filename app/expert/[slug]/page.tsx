...
import { ArrowLeft, CalendarRange, Globe, ShieldCheck, Star, Sword, Trophy } from 'lucide-react';
        ...
        <div className="container profile-layout">
          <div className="profile-main-card card">
            ...
            <div className="profile-header">
              <div>
                <div className="eyebrow pill">{expert.game} · coach verificado</div>
            ...
            <div className="detail-grid">
              <div className="detail-item">
                <Star size={16} />
                {expert.rating} de valoración media
              </div>
              <div className="detail-item">
                <CalendarRange size={16} />
                {expert.slots.length} horarios abiertos
              </div>
              <div className="detail-item">
                <Globe size={16} />
              ...
              <div className="detail-item">
                <ShieldCheck size={16} />
                Respuesta media {expert.responseTime}
              </div>
            </div>
